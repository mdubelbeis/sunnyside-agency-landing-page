const ProductItem = ({
  ...
  return (
    <div className={`md:flex ${flexDir}`}>
      ...
      <div className="py-16 px-10 w-full space-y-4 lg:space-y-6 text-center md:w-6/12 md:text-left md:flex md:flex-col md:items-start md:justify-center lg:px-20">
